...
<div class="container">
        ...
        <div class="card-header">
            <div class="row">
                ...
                <div class="col-4" style="text-align:right;padding-right:15px"> 
                    <a href="{{route('buzons.index')}}" class="btn btn-primary"><svg width="3em" height="2em" viewBox="0 0 16 16" class="bi bi-arrow-left" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
  ...
  <path fill-rule="evenodd" d="M2.5 8a.5.5 0 0 1 .5-.5h10.5a.5.5 0 0 1 0 1H3a.5.5 0 0 1-.5-.5z"/>
    ...
    <div class="card-body">
            ...
            <input type="text" readonly class="form-control" id="staticEmail" value="{{$buzon->fecha}}">
        </div>
                                <div class="form-group">
