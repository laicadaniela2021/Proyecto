        ...
        <div class="card-header">
            <div class="row">
                ...
                <div class="col-4" style="text-align:right;padding-right:15px"> 
                    <a href="{{route('snacks.index')}}" class="btn btn-primary"><svg width="3em" height="2em" viewBox="0 0 16 16" class="bi bi-arrow-left" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
