...
<div class="container">
    ...
    <form action="{{route('snacks.update',['snack'=>$snack->id])}}" method="POST" novalidate>
        ...
        @method('PUT')
            ...
            <label for="precio">Precio</label>
                    <input class="form-control Float"  type="text"  name="precio" id="precio" value="{{old('precio',$snack->precio)}}"
                                    required="required"
                        >
  ...
  <path fill-rule="evenodd" d="M13.854 3.646a.5.5 0 0 1 0 .708l-7 7a.5.5 0 0 1-.708 0l-3.5-3.5a.5.5 0 1 1 .708-.708L6.5 10.293l6.646-6.647a.5.5 0 0 1 .708 0z"/>
            ...
            <a href="{{route('snacks.index')}}" class="btn btn-primary"><svg width="4em" height="2em" viewBox="0 0 16 16" class="bi bi-arrow-left" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
