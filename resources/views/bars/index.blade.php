...
<div class="container">
        ...
        <div class="card-header">
            <div class="row">
                ...
                <div class="col-4" style="text-align:right;padding-right:35px"> 
                    <a href="{{route('bars.create')}}" class="btn btn-success"><svg width="2em" height="2em" viewBox="0 0 16 16" class="bi bi-plus" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                        <path fill-rule="evenodd" d="M8 3.5a.5.5 0 0 1 .5.5v4a.5.5 0 0 1-.5.5H4a.5.5 0 0 1 0-1h3.5V4a.5.5 0 0 1 .5-.5z"/>
                        <path fill-rule="evenodd" d="M7.5 8a.5.5 0 0 1 .5-.5h4a.5.5 0 0 1 0 1H8.5V12a.5.5 0 0 1-1 0V8z"/></svg>
                    </a>
                </div>
    ...
    <table class="table table-striped">
        ...
        <tbody>
            ...
            <tr>
                <td>
                    <a href="{{route('bars.show',['bar'=>$bar] )}}" class="btn btn-info"><svg width="2em" height="2em" viewBox="0 0 16 16" class="bi bi-eye" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <a href="{{route('bars.edit',['bar'=>$bar] )}}" class="btn btn-primary"><svg width="2em" height="2em" viewBox="0 0 16 16" class="bi bi-pencil" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <a href="javascript:void(0)" onclick="event.preventDefault(); document.getElementById('delete-bar-{{$bar->id}}').submit();" class="btn btn-danger"><svg width="2em" height="2em" viewBox="0 0 16 16" class="bi bi-trash" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
